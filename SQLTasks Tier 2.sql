...
SELECT concat(firstname,' ' ,surname) AS GuestName, name
FROM Members AS M
...
-- This part I was unable to do it because of some trouble connecting to the DB through Python, I contacted Tim and still 
We tried several different solutions but were unable to connect. 
